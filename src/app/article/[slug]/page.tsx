    ...
    if (slug === "the-man-who-cant-be-moved") {
        return {
            ...
            content: `
                ...
                <p>ကျောင်းသားတွေ မနက် ၉ နာရီအတန်းကို အပြေးအလွှား သွားနေကြချိန်၊ Algorithm တွေ Data Structure တွေနဲ့ ခေါင်းရှုပ်နေကြချိန်မှာ သူ့ကို မြင်လိုက်ရတာက စိတ်သက်သာရာ ရစေပါတယ်။ ဇွဲရှိဖို့ လိုအပ်ကြောင်း သတိပေးနေသလိုပါပဲ။</p>
